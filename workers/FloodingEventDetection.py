    ...
    while True:
        if time.time() - local_timer > refresh_timer:
            ...
            for _streamer_ in available_streamers:
                ...
                _query_ = generate_social_query(_streamer_=_streamer_, _topic_="flooding")
            ...
            list_tracker_key = "assed:flooding:event:detection:multisource:listkey"
            list_push_key = "assed:flooding:event:detection:multisource:list"
            list_info_key = "assed:flooding:event:detection:multisource:info"
